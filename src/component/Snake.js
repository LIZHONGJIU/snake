...
export default class Snake extends React.Component {
    constructor(props) {
        ...
        this.resetToHistory = this.resetToHistory.bind(this);
    ...
    move = () => {
        ...
        this.history = this.history.length>=3?[...this.history.slice(1), {...this.state}]:[...this.history, {...this.state}];
    ...
    render() {
        return (
            ...
            <div>
                <button className='game-info2' onClick={this.swich} > {this.state.started?'stop':'start'} </button> 
                <button className='game-info2' onClick={this.reset} > reset </button>
                <button className='game-info2' onClick={this.resetToHistory} > history </button>
                <button className='game-info2' onClick={this.save} > save </button>
            </div>
            <div className="game">
